...
namespace ManquitaBuilder
{
    ...
    public class MenuManager : MonoBehaviour
    {
        ...
        [Header("Buttons")] [SerializeField] private CanvasGroup buttonsCanvasGroup;
        ...
        [Header("Credits")] [SerializeField] private GameObject creditsPanel;
        ...
        void ExitCredits()
        {
            ...
            buttonsCanvasGroup.DOFade(1, creditsTweenDuration).SetEase(Ease.Linear).OnComplete(AllowButtonsInteraction)
                .Play();
