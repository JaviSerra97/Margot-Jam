...
namespace ManquitaBuilder
{
    ...
    {
        [Header("Condicion de victoria")] public int ScoreToBeat = 200000;
        public static bool GameBeated = false;

        public static ScoreManager Instance;

        [Header("Referencias")] public TextMeshProUGUI ScoreText;
        public TextMeshProUGUI MultiplierText;
        public GameObject FinalScorePanel;
        public GameObject Record;

        [Header("DoTween")] public GameObject scoreTextPrefab;
        public Transform scorePoint;
        public float scaleDuration;
        public float moveDuration;
        [Header("Canvas")] public GameObject canvas;
        [Header("Animator walking man")] public Animator SeniorAnim;
        public Animator ShadowAnim;
        [Header("Panels")] public GameObject scorePanel;
        ...
        public void AddPoints(int points, Vector3 pos)
        {
            ...
            var t = Instantiate(scoreTextPrefab, Camera.main.WorldToScreenPoint(pos), Quaternion.identity,
                canvas.transform);
            ...
            seq.Append(t.transform.DOMove(scorePoint.position, moveDuration * Random.Range(0.8f, 1.2f))
            ...
            foreach (PieceDrop piece in pieces)
            {
                switch (piece.ubicacion)
                {
                    ...
                    case PieceDrop.UbicacionSprite.Detalles:
                        if (piece.transform.position.y > -2 && piece.transform.position.y < 4 &&
                            piece.transform.position.x > -6 && piece.transform.position.x < 6)
